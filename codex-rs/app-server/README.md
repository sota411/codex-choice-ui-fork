...
- `tool/requestUserInput` — prompt the user with short questions for a tool call and return their answers. The default limit is 3 questions and can be configured with `tools.experimental_request_user_input.max_questions` (experimental).
